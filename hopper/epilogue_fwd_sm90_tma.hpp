...
struct CollectiveEpilogueFwd {
  ...
  static Params to_underlying_arguments(Arguments const& args) {
    ...
    TMA_O tma_store_O = make_tma_copy(
        ...
        _1{}); // no mcast for O
    return {
        args.ptr_O, args.layout_O, args.ptr_LSE, args.layout_LSE, tma_store_O};
  }
  ...
  CUTLASS_DEVICE void store(
    ...
    Tensor mLSE = make_tensor(
        make_gmem_ptr(epilogue_params.ptr_LSE), epilogue_params.layout_LSE);
...
#pragma unroll
    ...
    flash::write_O<!Seqlen_traits::kUseVarSeqLen, NumCopyThreads>(
        epilogue_params.ptr_O,
        epilogue_params.tma_store_O,
        gmem_tiled_copy_O,
  ...
  CUTLASS_DEVICE void store_fp8(
    ...
    Tensor sOacc = make_tensor(
        make_smem_ptr(shared_storage.smem_o.data()), SmemLayoutrO{});
...
#pragma unroll
  ...
  CUTLASS_DEVICE void store_zero(
    ...
    Tensor mO = make_tensor(
        make_gmem_ptr(epilogue_params.ptr_O), epilogue_params.layout_O);
