...
struct Flash_fwd_kernel_traits_fp8 {
  ...
  using SharedStorage = SharedStorageQKVOVt<
      kStages,
      Element,
      Element,
      OutputType,
...
struct Flash_bwd_kernel_traits {
  ...
  static_assert(
      kNThreadsNonWS % kGmemThreadsPerRow == 0,
  ...
  using GmemLayoutAtomdQaccum = std::conditional_t<
      kBlockKSmem == 32,
      Layout<
          Shape<Int<kNThreadsdQ / 8>, _8>, // Thread layout, 8 threads per row
          Stride<_8, _1>>,
      Layout<
          Shape<Int<kNThreadsdQ / 16>, _16>, // Thread layout, 16 threads per
                                             // row
          Stride<_16, _1>>>;
  ...
  using SmemLayoutAtomdQ = decltype(
      ...
      composition(
          Swizzle<3, 3, 3>{},
          Layout<
              Shape<Int<kNThreadsdQ / 32>, Int<32>>,
              Stride<Int<32>, _1>>{}));
...
struct Flash_bwd_seqqpar_kernel_traits {
  ...
  using GmemLayoutAtomdQaccum = std::conditional_t<
      kBlockKSmem == 32,
      Layout<
          Shape<_32, _8>, // Thread layout, 8 threads per row
          Stride<_8, _1>>,
      Layout<
          Shape<_16, _16>, // Thread layout, 16 threads per row
          Stride<_16, _1>>>;
  using GmemTiledCopydQaccum = decltype(make_tiled_copy(
      Copy_Atom<DefaultCopy, ElementAccum>{},
      GmemLayoutAtomdQaccum{},
